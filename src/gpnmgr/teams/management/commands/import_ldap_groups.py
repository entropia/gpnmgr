...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--autocreate-teams', action='store_true', help='Automatically create teams if they don\'t exist')

    def handle(self, *args, dry_run, autocreate_teams, **options):
        if dry_run:
            print('DRY RUN')
        ...
        for entry in entries:
            ...
            if autocreate_teams and not dry_run:
                ...
                if team is None:
                    if autocreate_teams:
                        ...
                        print(_('Team not existing, skipping'))
